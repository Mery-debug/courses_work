...
def top_5_result() -> list[dict]:
    return [
        ...
        {
            "date": "31.12.2021 15:44:39",
            "amount": -78.05,
            "category": "Супермаркеты",
            "description": "Колхоз",
        },
        {
            "date": "31.12.2021 16:39:04",
            "amount": -118.12,
            "category": "Супермаркеты",
            "description": "Магнит",
        },
...
def top_5_transaction() -> list[dict]:
    return [
        {
            "date of operation": "31.12.2021 16:44:00",
            "date of currency": "31.12.2021",
            "card number": "*7197",
            "status": "OK",
            "operation": {"add": -160.89, "currency": "RUB"},
            "add": -160.89,
            "currency": "RUB",
            "cashback": None,
            "category": "Супермаркеты",
            "description": "Колхоз",
            "Investment bank": 0,
            "add with round": 160.89,
        },
        {
            "date of operation": "31.12.2021 16:42:04",
            "date of currency": "31.12.2021",
            "card number": "*7197",
            "status": "OK",
            "operation": {"add": -64.0, "currency": "RUB"},
            "add": -64.0,
            "currency": "RUB",
            "cashback": None,
            "category": "Супермаркеты",
        ...
        {
            "date of operation": "31.12.2021 16:39:04",
            "date of currency": "31.12.2021",
            "card number": "*7197",
            "status": "OK",
            "operation": {"add": -118.12, "currency": "RUB"},
            "add": -118.12,
            "currency": "RUB",
            "cashback": None,
            "category": "Супермаркеты",
            "description": "Магнит",
            "Investment bank": 0,
            "add with round": 118.12,
        },
        {
            "date of operation": "31.12.2021 15:44:39",
            "date of currency": "31.12.2021",
            "card number": "*7197",
            "status": "OK",
            "operation": {"add": -78.05, "currency": "RUB"},
            "add": -78.05,
            "currency": "RUB",
            "cashback": None,
            "category": "Супермаркеты",
            "description": "Колхоз",
            "Investment bank": 0,
            "add with round": 78.05,
        },
        {
            "date of operation": "15.09.2021 15:38:43",
            "date of currency": "15.09.2021",
            "card number": None,
            "status": "OK",
            "operation": {"add": 100000.0, "currency": "RUB"},
            "add": 100000.0,
            "currency": "RUB",
            "cashback": None,
            "category": "Пополнения",
...
def trans() -> list[dict]:
    return [
        {"sum": 300, "category": "lup", "date of operation": "31.12.2021 16:44:00"},
...
def read_file():
    return [
        {"card number": "1234", "operation add": 100.456, "total cash": 10},
...
def exp() -> dict:
    return {
        ...
        "cards": [
            {"last_digits": "*7197", "total_spend": -1246134.37, "cashback": -12461.34},
            {"last_digits": "*5091", "total_spend": -35718.16, "cashback": -357.18},
            {"last_digits": "*4556", "total_spend": 177266.73, "cashback": 1772.67},
            {"last_digits": "*1112", "total_spend": -1000.0, "cashback": -10.0},
        ],
        "top_transaction": [
            {
        ...
        "currency rate": [
            {"currency": "USD", "rate": 98.0},
            {"currency": "EUR", "rate": 105.77},
        ],
        "stock_prices": [
