from src.utils import top_5, read_file, card_info, hello_date, return_cash, return_invest
...
def test_return_invest(mock_getenv, mock_requests_get, mock_open):
    ...
    mock_requests_get.return_value.json.return_value = [{"symbol": "AAPL", "price": 150.0}]
